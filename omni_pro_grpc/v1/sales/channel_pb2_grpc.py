...
class ChannelService(object):
    ...
    def ChannelCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.channel.ChannelService/ChannelCreate',
    ...
    def ChannelRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.channel.ChannelService/ChannelRead',
    ...
    def ChannelUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.channel.ChannelService/ChannelUpdate',
    ...
    def ChannelDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.channel.ChannelService/ChannelDelete',
