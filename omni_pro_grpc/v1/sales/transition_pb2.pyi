...
class Transition(_message.Message):
    __slots__ = ["id", "flow", "source_state", "destination_state", "trigger", "description", "logic", "active", "external_id", "object_audit"]
    ...
    def __init__(self, id: _Optional[int] = ..., flow: _Optional[_Union[_flow_pb2.Flow, _Mapping]] = ..., source_state: _Optional[_Union[_state_pb2.State, _Mapping]] = ..., destination_state: _Optional[_Union[_state_pb2.State, _Mapping]] = ..., trigger: _Optional[str] = ..., description: _Optional[str] = ..., logic: _Optional[str] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...

class TransitionCreateRequest(_message.Message):
    __slots__ = ["flow_id", "source_state_id", "destination_state_id", "trigger", "description", "logic", "external_id", "context"]
    ...
    def __init__(self, flow_id: _Optional[int] = ..., source_state_id: _Optional[int] = ..., destination_state_id: _Optional[int] = ..., trigger: _Optional[str] = ..., description: _Optional[str] = ..., logic: _Optional[str] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class TransitionCreateResponse(_message.Message):
    ...
    def __init__(self, transition: _Optional[_Union[Transition, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class TransitionReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, transitions: _Optional[_Iterable[_Union[Transition, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class TransitionUpdateRequest(_message.Message):
    ...
    transition: Transition
    context: _base_pb2.Context
    def __init__(self, transition: _Optional[_Union[Transition, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
