...
class Address(_message.Message):
    __slots__ = ["id", "client", "address_doc_id", "address_code", "code", "name", "active", "external_id", "object_audit"]
    ...
    def __init__(self, id: _Optional[int] = ..., client: _Optional[_Union[_client_pb2.Client, _Mapping]] = ..., address_doc_id: _Optional[str] = ..., address_code: _Optional[str] = ..., code: _Optional[str] = ..., name: _Optional[str] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class AddressCreateRequest(_message.Message):
    ...
    def __init__(self, client_id: _Optional[int] = ..., address_doc_id: _Optional[str] = ..., address_code: _Optional[str] = ..., code: _Optional[str] = ..., name: _Optional[str] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class AddressCreateResponse(_message.Message):
    ...
    def __init__(self, address: _Optional[_Union[Address, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class AddressReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, addresses: _Optional[_Iterable[_Union[Address, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class AddressUpdateRequest(_message.Message):
    ...
    address: Address
    context: _base_pb2.Context
    def __init__(self, address: _Optional[_Union[Address, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
