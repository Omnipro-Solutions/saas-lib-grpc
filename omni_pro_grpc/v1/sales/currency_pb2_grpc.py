...
class CurrencyService(object):
    ...
    def CurrencyCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.currency.CurrencyService/CurrencyCreate',
    ...
    def CurrencyRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.currency.CurrencyService/CurrencyRead',
    ...
    def CurrencyUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.currency.CurrencyService/CurrencyUpdate',
    ...
    def CurrencyDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.currency.CurrencyService/CurrencyDelete',
