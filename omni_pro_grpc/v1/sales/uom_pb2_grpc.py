...
class UomService(object):
    ...
    def UomCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.uom.UomService/UomCreate',
    ...
    def UomRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.uom.UomService/UomRead',
    ...
    def UomUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.uom.UomService/UomUpdate',
    ...
    def UomDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.uom.UomService/UomDelete',
