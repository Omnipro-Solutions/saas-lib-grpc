...
from omni_pro_grpc.v1.sales import order_line_pb2 as v1_dot_sales_dot_order__line__pb2
...
class OrderLineService(object):
    ...
    def OrderLineCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.order.line.OrderLineService/OrderLineCreate',
    ...
    def OrderLineRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.order.line.OrderLineService/OrderLineRead',
    ...
    def OrderLineUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.order.line.OrderLineService/OrderLineUpdate',
    ...
    def OrderLineDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.order.line.OrderLineService/OrderLineDelete',
