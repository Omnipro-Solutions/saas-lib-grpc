...
class SaleService(object):
    ...
    def SaleCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.sale.SaleService/SaleCreate',
    ...
    def SaleRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.sale.SaleService/SaleRead',
    ...
    def SaleUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.sale.SaleService/SaleUpdate',
    ...
    def SaleDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.sale.SaleService/SaleDelete',
    ...
    @staticmethod
    def SaleCreateIntegration(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.sale.SaleService/SaleCreateIntegration',
