...
class PickingService(object):
    ...
    def PickingCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.picking.PickingService/PickingCreate',
    ...
    def PickingRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.picking.PickingService/PickingRead',
    ...
    def PickingUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.picking.PickingService/PickingUpdate',
    ...
    def PickingDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.sales.picking.PickingService/PickingDelete',
