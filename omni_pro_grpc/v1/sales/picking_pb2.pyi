...
class Picking(_message.Message):
    ...
    def __init__(self, id: _Optional[int] = ..., name: _Optional[str] = ..., order_id: _Optional[int] = ..., picking_sql_id: _Optional[int] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class PickingCreateRequest(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., order_id: _Optional[int] = ..., picking_sql_id: _Optional[int] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
