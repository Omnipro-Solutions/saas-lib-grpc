...
from omni_pro_grpc.v1.stock import picking_picker_pb2 as v1_dot_stock_dot_picking__picker__pb2
...
class PickingPickerService(object):
    ...
    def PickingPickerRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.stock.picking_picker.PickingPickerService/PickingPickerRead',
