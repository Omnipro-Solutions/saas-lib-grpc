...
class WarehousePicker(_message.Message):
    ...
    def __init__(self, id: _Optional[int] = ..., warehouse: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., pick: _Optional[int] = ..., pack: _Optional[int] = ..., out: _Optional[int] = ..., returned: _Optional[int] = ..., internal: _Optional[int] = ..., incoming: _Optional[int] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class WarehousePickerReadResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., warehouse_pickers: _Optional[_Iterable[_Union[WarehousePicker, _Mapping]]] = ...) -> None: ...
