...
class PickingPicker(_message.Message):
    __slots__ = ["id", "warehouse", "picking_type", "draft", "waiting", "confirmed", "assigned", "active", "object_audit"]
    ...
    def __init__(self, id: _Optional[int] = ..., warehouse: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., picking_type: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., draft: _Optional[int] = ..., waiting: _Optional[int] = ..., confirmed: _Optional[int] = ..., assigned: _Optional[int] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class PickingPickerReadResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., picking_pickers: _Optional[_Iterable[_Union[PickingPicker, _Mapping]]] = ...) -> None: ...
