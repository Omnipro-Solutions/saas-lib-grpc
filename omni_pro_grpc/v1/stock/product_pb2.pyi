...
class Product(_message.Message):
    __slots__ = ["id", "product_doc_id", "template_doc_id", "sku", "category", "name", "code", "active", "external_id", "object_audit"]
    ...
    def __init__(self, id: _Optional[int] = ..., product_doc_id: _Optional[str] = ..., template_doc_id: _Optional[str] = ..., sku: _Optional[str] = ..., category: _Optional[str] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class ProductCreateRequest(_message.Message):
    ...
    def __init__(self, product_doc_id: _Optional[str] = ..., template_doc_id: _Optional[str] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class ProductReadResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., products: _Optional[_Iterable[_Union[Product, _Mapping]]] = ...) -> None: ...
