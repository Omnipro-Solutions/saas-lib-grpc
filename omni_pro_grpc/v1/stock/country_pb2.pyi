...
class Country(_message.Message):
    ...
    def __init__(self, id: _Optional[int] = ..., country_doc_id: _Optional[str] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class CountryCreateRequest(_message.Message):
    ...
    def __init__(self, country_doc_id: _Optional[str] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
