...
class WarehousePickerService(object):
    ...
    @staticmethod
    def WarehousePickerRead(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.stock.warehouse_picker.WarehousePickerService/WarehousePickerRead',
