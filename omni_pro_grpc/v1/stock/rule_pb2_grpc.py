...
from omni_pro_grpc.v1.stock import rule_pb2 as v1_dot_stock_dot_rule__pb2
...
def add_RuleServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'pro.omni.oms.api.v1.rule.RuleService', rpc_method_handlers)
...
class RuleService(object):
    ...
    def RuleCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rule.RuleService/RuleCreate',
    ...
    def RuleRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rule.RuleService/RuleRead',
    ...
    def RuleUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rule.RuleService/RuleUpdate',
    ...
    def RuleDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rule.RuleService/RuleDelete',
