...
class StockMove(_message.Message):
    __slots__ = ["id", "picking", "state", "product", "quantity_done", "product_uom", "description_picking", "qty_reserved", "active", "external_id", "object_audit"]
    ...
    def __init__(self, id: _Optional[int] = ..., picking: _Optional[_Union[_picking_pb2.Picking, _Mapping]] = ..., state: _Optional[str] = ..., product: _Optional[_Union[_product_pb2.Product, _Mapping]] = ..., quantity_done: _Optional[float] = ..., product_uom: _Optional[_Union[_uom_pb2.Uom, _Mapping]] = ..., description_picking: _Optional[str] = ..., qty_reserved: _Optional[float] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...

class StockMoveCreateRequest(_message.Message):
    __slots__ = ["picking_id", "state", "product_id", "quantity_done", "product_uom_id", "description_picking", "qty_reserved", "external_id", "context"]
    ...
    def __init__(self, picking_id: _Optional[int] = ..., state: _Optional[str] = ..., product_id: _Optional[str] = ..., quantity_done: _Optional[float] = ..., product_uom_id: _Optional[str] = ..., description_picking: _Optional[str] = ..., qty_reserved: _Optional[float] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class StockMoveCreateResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., stock_move: _Optional[_Union[StockMove, _Mapping]] = ...) -> None: ...
...
class StockMoveReadResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., stock_moves: _Optional[_Iterable[_Union[StockMove, _Mapping]]] = ...) -> None: ...
...
class StockMoveUpdateRequest(_message.Message):
    ...
    stock_move: StockMove
    context: _base_pb2.Context
    def __init__(self, stock_move: _Optional[_Union[StockMove, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
