...
class WarehouseService(object):
    ...
    def WarehouseCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.stock.warehouse.WarehouseService/WarehouseCreate',
    ...
    def WarehouseRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.stock.warehouse.WarehouseService/WarehouseRead',
    ...
    def WarehouseUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.stock.warehouse.WarehouseService/WarehouseUpdate',
    ...
    def WarehouseDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.stock.warehouse.WarehouseService/WarehouseDelete',
