...
from omni_pro_grpc.v1.stock import quant_pb2 as v1_dot_stock_dot_quant__pb2
...
class QuantService(object):
    ...
    def QuantCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.stock.quant.QuantService/QuantCreate',
    ...
    def QuantRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.stock.quant.QuantService/QuantRead',
    ...
    def QuantUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.stock.quant.QuantService/QuantUpdate',
    ...
    def QuantDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.stock.quant.QuantService/QuantDelete',
    ...
    def ProductAvailable(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.stock.quant.QuantService/ProductAvailable',
