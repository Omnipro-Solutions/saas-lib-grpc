...
class Country(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., country_doc_id: _Optional[str] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class CountryCreateRequest(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., code: _Optional[str] = ..., category_doc_id: _Optional[str] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class CountryReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, countries: _Optional[_Iterable[_Union[Country, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
