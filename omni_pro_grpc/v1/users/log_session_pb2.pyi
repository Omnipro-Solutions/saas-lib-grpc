...
class LogSession(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., user: _Optional[_Union[_user_pb2.User, _Mapping]] = ..., operation: _Optional[str] = ..., date_start: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., date_end: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class LogSessionReadResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., log_sessions: _Optional[_Iterable[_Union[LogSession, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ...) -> None: ...
...
class PausedMethodRequest(_message.Message):
    ...
    type: str
    context: _base_pb2.Context
    def __init__(self, id: _Optional[str] = ..., type: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class PausedMethodResponse(_message.Message):
    ...
    meta_data: _base_pb2.MetaData
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., log_session: _Optional[_Union[LogSession, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ...) -> None: ...
