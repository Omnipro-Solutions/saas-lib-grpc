...
from omni_pro_grpc.v1.utilities import uom_pb2 as v1_dot_utilities_dot_uom__pb2
...
class UomService(object):
    ...
    def UomCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.uom.UomService/UomCreate',
    ...
    def UomRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.uom.UomService/UomRead',
    ...
    def UomUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.uom.UomService/UomUpdate',
    ...
    def UomDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.uom.UomService/UomDelete',
