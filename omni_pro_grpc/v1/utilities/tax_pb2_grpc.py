...
from omni_pro_grpc.v1.utilities import tax_pb2 as v1_dot_utilities_dot_tax__pb2
...
class TaxService(object):
    ...
    def TaxAdd(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.tax.TaxService/TaxAdd',
    ...
    def TaxRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.tax.TaxService/TaxRead',
    ...
    def TaxUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.tax.TaxService/TaxUpdate',
    ...
    def TaxDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.tax.TaxService/TaxDelete',
