...
from omni_pro_grpc.v1.utilities import dashboard_pb2 as _dashboard_pb2
...
class DashboardWidget(_message.Message):
    ...
    description: str
    position: _struct_pb2.Struct
    size: _struct_pb2.Struct
    type: str
    ...
    def __init__(
        ...
        position: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...,
        size: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...,
        type: _Optional[str] = ...,
