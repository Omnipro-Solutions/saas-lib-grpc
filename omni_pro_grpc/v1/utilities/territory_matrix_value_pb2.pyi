...
class TerritoryMatrixValueAddRequest(_message.Message):
    ...
    def __init__(self, territory_matrixes: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., data: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class TerritoryMatrixValueAddResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., territory_matrix_value: _Optional[_Union[TerritoryMatrixValue, _Mapping]] = ...) -> None: ...
...
class TerritoryMatrixValueReadResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., territory_matrixes_values: _Optional[_Iterable[_Union[TerritoryMatrixValue, _Mapping]]] = ...) -> None: ...
...
class TerritoryMatrixValueUpdateRequest(_message.Message):
    ...
    territory_matrix_value: TerritoryMatrixValue
    context: _base_pb2.Context
    def __init__(self, territory_matrix_value: _Optional[_Union[TerritoryMatrixValue, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
