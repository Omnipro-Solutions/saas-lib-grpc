...
class MicroserviceService(object):
    ...
    @staticmethod
    def MicroserviceCreate(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.microservice.MicroserviceService/MicroserviceCreate',
    ...
    def MicroserviceRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.microservice.MicroserviceService/MicroserviceRead',
    ...
    @staticmethod
    def MicroserviceUpdate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.microservice.MicroserviceService/MicroserviceUpdate',
    ...
    @staticmethod
    def MicroserviceDelete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.microservice.MicroserviceService/MicroserviceDelete',
