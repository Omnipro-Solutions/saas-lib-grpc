...
class Country(_message.Message):
    __slots__ = ["id", "code", "name", "phone_number_size", "phone_prefix", "require_zipcode", "currencies", "document_types", "territory_matrixes", "meta_data", "timezones", "languages", "low_level", "icon", "active", "external_id", "object_audit"]
    ...
    def __init__(self, id: _Optional[str] = ..., code: _Optional[str] = ..., name: _Optional[str] = ..., phone_number_size: _Optional[int] = ..., phone_prefix: _Optional[str] = ..., require_zipcode: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., currencies: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., document_types: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., territory_matrixes: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., meta_data: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., timezones: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., languages: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., low_level: _Optional[str] = ..., icon: _Optional[bytes] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...

class CountryCreateRequest(_message.Message):
    __slots__ = ["code", "name", "phone_number_size", "phone_prefix", "require_zipcode", "currencies_ids", "document_types_ids", "territory_matrixes_ids", "meta_data", "timezones_ids", "languages_ids", "low_level", "icon", "external_id", "context"]
    CODE_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    PHONE_NUMBER_SIZE_FIELD_NUMBER: _ClassVar[int]
    PHONE_PREFIX_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, code: _Optional[str] = ..., name: _Optional[str] = ..., phone_number_size: _Optional[int] = ..., phone_prefix: _Optional[str] = ..., require_zipcode: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., currencies_ids: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., document_types_ids: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., territory_matrixes_ids: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., meta_data: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., timezones_ids: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., languages_ids: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., low_level: _Optional[str] = ..., icon: _Optional[bytes] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class CountryCreateResponse(_message.Message):
    ...
    country: Country
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., country: _Optional[_Union[Country, _Mapping]] = ...) -> None: ...
...
class CountryReadResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., countries: _Optional[_Iterable[_Union[Country, _Mapping]]] = ...) -> None: ...
