...
class Event(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., model: _Optional[_Union[_model_pb2.Model, _Mapping]] = ..., operation: _Optional[str] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class EventCreateRequest(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., code: _Optional[str] = ..., model_id: _Optional[str] = ..., operation: _Optional[str] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class EventCreateResponse(_message.Message):
    ...
    event: Event
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., event: _Optional[_Union[Event, _Mapping]] = ...) -> None: ...
...
class EventReadResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., events: _Optional[_Iterable[_Union[Event, _Mapping]]] = ...) -> None: ...
...
class EventUpdateRequest(_message.Message):
    ...
    event: Event
    context: _base_pb2.Context
    def __init__(self, event: _Optional[_Union[Event, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
