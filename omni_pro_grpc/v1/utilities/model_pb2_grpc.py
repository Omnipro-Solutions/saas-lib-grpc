...
class ModelsService(object):
    ...
    def ModelCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.model.ModelsService/ModelCreate',
    ...
    def ModelRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.model.ModelsService/ModelRead',
    ...
    def ModelUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.model.ModelsService/ModelUpdate',
    ...
    def ModelDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.model.ModelsService/ModelDelete',
