...
from omni_pro_grpc.v1.utilities import country_pb2 as v1_dot_utilities_dot_country__pb2
...
class CountryService(object):
    ...
    def CountryCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.country.CountryService/CountryCreate',
    ...
    def CountryRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.country.CountryService/CountryRead',
    ...
    def CountryUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.country.CountryService/CountryUpdate',
    ...
    def CountryDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.country.CountryService/CountryDelete',
