...
from omni_pro_grpc.v1.utilities import payment_method_pb2 as v1_dot_utilities_dot_payment__method__pb2
...
class PaymentMethodService(object):
    ...
    def PaymentMethodAdd(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.payment_method.PaymentMethodService/PaymentMethodAdd',
    ...
    def PaymentMethodRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.payment_method.PaymentMethodService/PaymentMethodRead',
    ...
    def PaymentMethodUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.payment_method.PaymentMethodService/PaymentMethodUpdate',
    ...
    def PaymentMethodDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.payment_method.PaymentMethodService/PaymentMethodDelete',
