...
class Timezone(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., offset: _Optional[int] = ..., offset_dst: _Optional[int] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class TimezoneAddRequest(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., code: _Optional[str] = ..., offset: _Optional[int] = ..., offset_dst: _Optional[int] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class TimezoneUpdateRequest(_message.Message):
    ...
    timezone: Timezone
    context: _base_pb2.Context
    def __init__(self, timezone: _Optional[_Union[Timezone, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
