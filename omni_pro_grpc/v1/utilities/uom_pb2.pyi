...
class Uom(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., category: _Optional[str] = ..., code: _Optional[str] = ..., name: _Optional[str] = ..., type: _Optional[str] = ..., rounding: _Optional[float] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class UomCreateRequest(_message.Message):
    ...
    def __init__(self, category: _Optional[str] = ..., code: _Optional[str] = ..., name: _Optional[str] = ..., type: _Optional[str] = ..., rounding: _Optional[float] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class UomCreateResponse(_message.Message):
    ...
    uom: Uom
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., uom: _Optional[_Union[Uom, _Mapping]] = ...) -> None: ...
...
class UomReadResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., uoms: _Optional[_Iterable[_Union[Uom, _Mapping]]] = ...) -> None: ...
...
class UomUpdateRequest(_message.Message):
    ...
    uom: Uom
    context: _base_pb2.Context
    def __init__(self, uom: _Optional[_Union[Uom, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
