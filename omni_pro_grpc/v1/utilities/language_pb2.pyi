...
class Language(_message.Message):
    __slots__ = ["id", "name", "code", "code_iso", "direction", "date_format", "time_format", "decimal_point", "thousands_separator", "grouping", "week_start", "icon", "active", "external_id", "object_audit"]
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., code_iso: _Optional[str] = ..., direction: _Optional[str] = ..., date_format: _Optional[str] = ..., time_format: _Optional[str] = ..., decimal_point: _Optional[str] = ..., thousands_separator: _Optional[str] = ..., grouping: _Optional[str] = ..., week_start: _Optional[str] = ..., icon: _Optional[bytes] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...

class LanguageAddRequest(_message.Message):
    __slots__ = ["name", "code", "code_iso", "direction", "date_format", "time_format", "decimal_point", "thousands_separator", "grouping", "week_start", "icon", "active", "external_id", "context"]
    NAME_FIELD_NUMBER: _ClassVar[int]
    CODE_FIELD_NUMBER: _ClassVar[int]
    CODE_ISO_FIELD_NUMBER: _ClassVar[int]
    DIRECTION_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str] = ..., code: _Optional[str] = ..., code_iso: _Optional[str] = ..., direction: _Optional[str] = ..., date_format: _Optional[str] = ..., time_format: _Optional[str] = ..., decimal_point: _Optional[str] = ..., thousands_separator: _Optional[str] = ..., grouping: _Optional[str] = ..., week_start: _Optional[str] = ..., icon: _Optional[bytes] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class LanguageUpdateRequest(_message.Message):
    ...
    language: Language
    context: _base_pb2.Context
    def __init__(self, language: _Optional[_Union[Language, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
