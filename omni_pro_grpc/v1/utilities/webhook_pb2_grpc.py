...
class WebhookService(object):
    ...
    def WebhookCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.webhook.WebhookService/WebhookCreate',
    ...
    def WebhookRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.webhook.WebhookService/WebhookRead',
    ...
    def WebhookUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.webhook.WebhookService/WebhookUpdate',
    ...
    def WebhookDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.webhook.WebhookService/WebhookDelete',
