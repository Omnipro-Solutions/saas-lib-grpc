...
from omni_pro_grpc.v1.utilities import models_replica_pb2 as v1_dot_utilities_dot_models__replica__pb2
...
class ModelsReplicaService(object):
    ...
    def ModelsReplica(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.utilities.models_replica.ModelsReplicaService/ModelsReplica',
