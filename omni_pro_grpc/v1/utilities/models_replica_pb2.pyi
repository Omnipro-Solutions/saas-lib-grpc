...
class ModelsReplicaRequest(_message.Message):
    ...
    def __init__(self, code: _Optional[str] = ..., date_start: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., date_end: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class ModelsReplicaResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., models_replica: _Optional[_Iterable[_Union[_struct_pb2.Struct, _Mapping]]] = ...) -> None: ...
