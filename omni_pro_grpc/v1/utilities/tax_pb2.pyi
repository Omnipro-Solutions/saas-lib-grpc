...
class Tax(_message.Message):
    __slots__ = ["id", "name", "code", "rate", "rounding", "decimal_places", "position", "active", "external_id", "object_audit"]
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., rate: _Optional[float] = ..., rounding: _Optional[float] = ..., decimal_places: _Optional[int] = ..., position: _Optional[str] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class TaxAddRequest(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., code: _Optional[str] = ..., rate: _Optional[float] = ..., rounding: _Optional[float] = ..., decimal_places: _Optional[int] = ..., position: _Optional[str] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
