...
class ComputeMethodData(_message.Message):
    ...
    def __init__(self, cart_details: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., items: _Optional[_Iterable[_Union[_struct_pb2.Struct, _Mapping]]] = ..., shipping_details: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
...
class ComputeMethodRequest(_message.Message):
    ...
    def __init__(self, version: _Optional[int] = ..., data: _Optional[_Iterable[_Union[ComputeMethodData, _Mapping]]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class ComputeMethodResponse(_message.Message):
    ...
    def __init__(self, result: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class ComputeMethodStockAvailableRequest(_message.Message):
    ...
    items: _containers.RepeatedCompositeFieldContainer[_struct_pb2.Struct]
    context: _base_pb2.Context
    def __init__(self, methods: _Optional[_Iterable[_Union[_struct_pb2.Struct, _Mapping]]] = ..., items: _Optional[_Iterable[_Union[_struct_pb2.Struct, _Mapping]]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class ComputeDeliveryCarrierData(_message.Message):
    ...
    def __init__(self, address: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., products: _Optional[_Iterable[_Union[_struct_pb2.Struct, _Mapping]]] = ..., warehouse_sql_id: _Optional[int] = ..., delivery_method_doc_id: _Optional[str] = ..., internal_transfer: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ...) -> None: ...
...
class ComputeDeliveryCarrierRequest(_message.Message):
    ...
    context: _base_pb2.Context
    def __init__(self, data: _Optional[_Union[ComputeDeliveryCarrierData, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class ComputeDeliveryCarrierResponse(_message.Message):
    ...
    carrier_sql_id: int
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, carrier_sql_id: _Optional[int] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
