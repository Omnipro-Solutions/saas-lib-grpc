...
class DeliveryLocalityMatrixValues(_message.Message):
    ...
    def __init__(self, id: _Optional[int] = ..., delivery_locality_id: _Optional[int] = ..., territory_matrix_values_id: _Optional[int] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class DeliveryLocalityMatrixValuesCreateRequest(_message.Message):
    ...
    def __init__(self, delivery_locality_id: _Optional[int] = ..., territory_matrix_values_id: _Optional[int] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
