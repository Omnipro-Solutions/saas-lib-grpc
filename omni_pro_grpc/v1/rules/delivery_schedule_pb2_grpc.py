...
class DeliveryScheduleService(object):
    ...
    @staticmethod
    def DeliveryScheduleCreate(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_schedule.DeliveryScheduleService/DeliveryScheduleCreate',
    ...
    @staticmethod
    def DeliveryScheduleRead(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_schedule.DeliveryScheduleService/DeliveryScheduleRead',
    ...
    @staticmethod
    def DeliveryScheduleUpdate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_schedule.DeliveryScheduleService/DeliveryScheduleUpdate',
    ...
    @staticmethod
    def DeliveryScheduleDelete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_schedule.DeliveryScheduleService/DeliveryScheduleDelete',
