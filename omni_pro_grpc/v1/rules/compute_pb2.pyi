...
class Compute(_message.Message):
    __slots__ = ["id", "data_request", "data_process", "data_response_internal", "data_response_external", "time", "date_created", "active", "external_id", "object_audit"]
    ...
    def __init__(self, id: _Optional[str] = ..., data_request: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., data_process: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., data_response_internal: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., data_response_external: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., time: _Optional[float] = ..., date_created: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...

class ComputeCreateRequest(_message.Message):
    __slots__ = ["data_request", "data_process", "data_response_internal", "data_response_external", "time", "date_created", "external_id", "context"]
    DATA_REQUEST_FIELD_NUMBER: _ClassVar[int]
    DATA_PROCESS_FIELD_NUMBER: _ClassVar[int]
    DATA_RESPONSE_INTERNAL_FIELD_NUMBER: _ClassVar[int]
    DATA_RESPONSE_EXTERNAL_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, data_request: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., data_process: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., data_response_internal: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., data_response_external: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., time: _Optional[float] = ..., date_created: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class ComputeCreateResponse(_message.Message):
    ...
    compute: Compute
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., compute: _Optional[_Union[Compute, _Mapping]] = ...) -> None: ...
...
class ComputeReadResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., compute: _Optional[_Iterable[_Union[Compute, _Mapping]]] = ...) -> None: ...
...
class ComputeUpdateRequest(_message.Message):
    ...
    compute: Compute
    context: _base_pb2.Context
    def __init__(self, compute: _Optional[_Union[Compute, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
