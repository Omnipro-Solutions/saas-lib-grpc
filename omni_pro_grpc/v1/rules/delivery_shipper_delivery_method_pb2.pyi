...
class DeliveryShipperDeliveryMethod(_message.Message):
    ...
    def __init__(self, id: _Optional[int] = ..., delivery_shipper_id: _Optional[int] = ..., delivery_method_id: _Optional[int] = ..., active: bool = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class DeliveryShipperDeliveryMethodCreateRequest(_message.Message):
    ...
    def __init__(self, delivery_shipper_id: _Optional[int] = ..., delivery_method_id: _Optional[int] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class DeliveryShipperDeliveryMethodCreateResponse(_message.Message):
    ...
    def __init__(self, delivery_shipper_delivery_method: _Optional[_Union[DeliveryShipperDeliveryMethod, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class DeliveryShipperDeliveryMethodReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, delivery_shipper_delivery_method: _Optional[_Iterable[_Union[DeliveryShipperDeliveryMethod, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class DeliveryShipperDeliveryMethodUpdateRequest(_message.Message):
    ...
    delivery_shipper_delivery_method: DeliveryShipperDeliveryMethod
    context: _base_pb2.Context
    def __init__(self, delivery_shipper_delivery_method: _Optional[_Union[DeliveryShipperDeliveryMethod, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
