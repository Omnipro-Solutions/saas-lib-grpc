...
class ComputeOperationService(object):
    ...
    def ComputeMethod(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.compute_operation.ComputeOperationService/ComputeMethod',
    ...
    @staticmethod
    def ComputeMethodStockAvailable(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.compute_operation.ComputeOperationService/ComputeMethodStockAvailable',
    ...
    @staticmethod
    def ComputeDeliveryCarrier(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.compute_operation.ComputeOperationService/ComputeDeliveryCarrier',
