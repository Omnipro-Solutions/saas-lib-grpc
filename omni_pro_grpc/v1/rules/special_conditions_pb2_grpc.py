...
class SpecialConditionsService(object):
    ...
    @staticmethod
    def SpecialConditionsCreate(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.special_conditions.SpecialConditionsService/SpecialConditionsCreate',
    ...
    @staticmethod
    def SpecialConditionsRead(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.special_conditions.SpecialConditionsService/SpecialConditionsRead',
    ...
    @staticmethod
    def SpecialConditionsUpdate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.special_conditions.SpecialConditionsService/SpecialConditionsUpdate',
    ...
    @staticmethod
    def SpecialConditionsDelete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.special_conditions.SpecialConditionsService/SpecialConditionsDelete',
