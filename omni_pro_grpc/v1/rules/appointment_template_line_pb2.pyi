...
class AppointmentTemplateLine(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., day: _Optional[str] = ..., hour_start: _Optional[str] = ..., hour_end: _Optional[str] = ..., order_numbers: _Optional[int] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class AppointmentTemplateLineCreateRequest(_message.Message):
    ...
    def __init__(self, day: _Optional[str] = ..., hour_start: _Optional[str] = ..., hour_end: _Optional[str] = ..., order_numbers: _Optional[int] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class AppointmentTemplateLineCreateResponse(_message.Message):
    ...
    def __init__(self, appointment_template_line: _Optional[_Union[AppointmentTemplateLine, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class AppointmentTemplateLineReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, appointment_template_lines: _Optional[_Iterable[_Union[AppointmentTemplateLine, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class AppointmentTemplateLineUpdateRequest(_message.Message):
    ...
    appointment_template_line: AppointmentTemplateLine
    context: _base_pb2.Context
    def __init__(self, appointment_template_line: _Optional[_Union[AppointmentTemplateLine, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
