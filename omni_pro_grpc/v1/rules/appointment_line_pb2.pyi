...
class AppointmentLine(_message.Message):
    __slots__ = ["id", "hour_start", "hour_end", "order_numbers", "appointment_available", "cids", "active", "external_id", "object_audit"]
    ...
    def __init__(self, id: _Optional[str] = ..., hour_start: _Optional[str] = ..., hour_end: _Optional[str] = ..., order_numbers: _Optional[int] = ..., appointment_available: _Optional[int] = ..., cids: _Optional[_Iterable[str]] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class AppointmentLineCreateRequest(_message.Message):
    ...
    def __init__(self, hour_start: _Optional[str] = ..., hour_end: _Optional[str] = ..., order_numbers: _Optional[int] = ..., appointment_available: _Optional[int] = ..., cids: _Optional[_Iterable[str]] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class AppointmentLineCreateResponse(_message.Message):
    ...
    def __init__(self, appointment_line: _Optional[_Union[AppointmentLine, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class AppointmentLineReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, appointment_lines: _Optional[_Iterable[_Union[AppointmentLine, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class AppointmentLineUpdateRequest(_message.Message):
    ...
    appointment_line: AppointmentLine
    context: _base_pb2.Context
    def __init__(self, appointment_line: _Optional[_Union[AppointmentLine, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
