...
class DeliveryPriceDeliveryMethod(_message.Message):
    ...
    def __init__(self, id: _Optional[int] = ..., delivery_price_id: _Optional[int] = ..., delivery_method_id: _Optional[int] = ..., active: bool = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class DeliveryPriceDeliveryMethodCreateRequest(_message.Message):
    ...
    def __init__(self, delivery_price_id: _Optional[int] = ..., delivery_method_id: _Optional[int] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class DeliveryPriceDeliveryMethodCreateResponse(_message.Message):
    ...
    def __init__(self, delivery_price_delivery_method: _Optional[_Union[DeliveryPriceDeliveryMethod, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class DeliveryPriceDeliveryMethodReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, delivery_price_delivery_method: _Optional[_Iterable[_Union[DeliveryPriceDeliveryMethod, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class DeliveryPriceDeliveryMethodUpdateRequest(_message.Message):
    ...
    delivery_price_delivery_method: DeliveryPriceDeliveryMethod
    context: _base_pb2.Context
    def __init__(self, delivery_price_delivery_method: _Optional[_Union[DeliveryPriceDeliveryMethod, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
