...
from omni_pro_grpc.v1.rules import picker_pb2 as v1_dot_rules_dot_picker__pb2
...
class PickerService(object):
    ...
    def PickerCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.picker.PickerService/PickerCreate',
    ...
    def PickerRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.picker.PickerService/PickerRead',
    ...
    def PickerUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.picker.PickerService/PickerUpdate',
    ...
    def PickerDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.picker.PickerService/PickerDelete',
