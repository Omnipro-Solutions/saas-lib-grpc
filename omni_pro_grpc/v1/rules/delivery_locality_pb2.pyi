...
from omni_pro_grpc.v1.rules import country_pb2 as _country_pb2
...
class DeliveryLocality(_message.Message):
    __slots__ = ["id", "name", "country", "code_collection", "items", "active", "external_id", "territory_matrix_values_front", "object_audit"]
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., country: _Optional[_Union[_country_pb2.Country, _Mapping]] = ..., code_collection: _Optional[str] = ..., items: _Optional[_Union[_struct_pb2.ListValue, _Mapping]] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., territory_matrix_values_front: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...

class DeliveryLocalityCreateRequest(_message.Message):
    __slots__ = ["name", "country_id", "code_collection", "items", "external_id", "territory_matrix_values_front", "context"]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str] = ..., country_id: _Optional[str] = ..., code_collection: _Optional[str] = ..., items: _Optional[_Iterable[str]] = ..., external_id: _Optional[str] = ..., territory_matrix_values_front: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
