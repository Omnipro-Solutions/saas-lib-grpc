...
class PythonCode(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., python_code: _Optional[str] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class PythonCodeRequest(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., python_code: _Optional[str] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class PythonCodeResponse(_message.Message):
    ...
    def __init__(self, python_code: _Optional[_Union[PythonCode, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class PythonCodeReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, python_codes: _Optional[_Iterable[_Union[PythonCode, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class PythonCodeUpdateRequest(_message.Message):
    ...
    python_code: PythonCode
    context: _base_pb2.Context
    def __init__(self, python_code: _Optional[_Union[PythonCode, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
