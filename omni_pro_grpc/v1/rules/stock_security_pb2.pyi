...
class ProductStockSecurity(_message.Message):
    ...
    def __init__(self, product_doc_id: _Optional[str] = ..., sku: _Optional[str] = ..., quantity_security: _Optional[float] = ...) -> None: ...
...
class StockSecurity(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., type: _Optional[str] = ..., products: _Optional[_Iterable[_Union[ProductStockSecurity, _Mapping]]] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class StockSecurityCreateRequest(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., code: _Optional[str] = ..., type: _Optional[str] = ..., products: _Optional[_Iterable[_Union[ProductStockSecurity, _Mapping]]] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class StockSecurityCreateResponse(_message.Message):
    ...
    def __init__(self, stock_security: _Optional[_Union[StockSecurity, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class StockSecurityReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, stock_security: _Optional[_Iterable[_Union[StockSecurity, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class StockSecurityUpdateRequest(_message.Message):
    ...
    stock_security: StockSecurity
    context: _base_pb2.Context
    def __init__(self, stock_security: _Optional[_Union[StockSecurity, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
