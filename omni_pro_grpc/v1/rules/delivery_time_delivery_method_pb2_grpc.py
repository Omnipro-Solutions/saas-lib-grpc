...
from omni_pro_grpc.v1.rules import delivery_time_delivery_method_pb2 as v1_dot_rules_dot_delivery__time__delivery__method__pb2
...
class DeliveryTimeDeliveryMethodService(object):
    ...
    @staticmethod
    def DeliveryTimeDeliveryMethodCreate(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_time_delivery_method.DeliveryTimeDeliveryMethodService/DeliveryTimeDeliveryMethodCreate',
    ...
    @staticmethod
    def DeliveryTimeDeliveryMethodRead(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_time_delivery_method.DeliveryTimeDeliveryMethodService/DeliveryTimeDeliveryMethodRead',
    ...
    @staticmethod
    def DeliveryTimeDeliveryMethodUpdate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_time_delivery_method.DeliveryTimeDeliveryMethodService/DeliveryTimeDeliveryMethodUpdate',
    ...
    @staticmethod
    def DeliveryTimeDeliveryMethodDelete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_time_delivery_method.DeliveryTimeDeliveryMethodService/DeliveryTimeDeliveryMethodDelete',
