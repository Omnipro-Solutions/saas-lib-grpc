...
class User(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., user_doc_id: _Optional[str] = ..., name: _Optional[str] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class UserCreateRequest(_message.Message):
    ...
    def __init__(self, user_doc_id: _Optional[str] = ..., name: _Optional[str] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class UserCreateResponse(_message.Message):
    ...
    def __init__(self, user: _Optional[_Union[User, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class UserReadResponse(_message.Message):
    ...
    def __init__(self, user: _Optional[_Iterable[_Union[User, _Mapping]]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ...) -> None: ...
