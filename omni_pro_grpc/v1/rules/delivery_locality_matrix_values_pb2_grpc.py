...
from omni_pro_grpc.v1.rules import delivery_locality_matrix_values_pb2 as v1_dot_rules_dot_delivery__locality__matrix__values__pb2
...
def add_DeliveryLocalityMatrixValuesServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'pro.omni.oms.api.v1.rules.delivery_locality_matrix_values.DeliveryLocalityMatrixValuesService', rpc_method_handlers)
...
class DeliveryLocalityMatrixValuesService(object):
    ...
    @staticmethod
    def DeliveryLocalityMatrixValuesCreate(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_locality_matrix_values.DeliveryLocalityMatrixValuesService/DeliveryLocalityMatrixValuesCreate',
    ...
    @staticmethod
    def DeliveryLocalityMatrixValuesRead(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_locality_matrix_values.DeliveryLocalityMatrixValuesService/DeliveryLocalityMatrixValuesRead',
    ...
    @staticmethod
    def DeliveryLocalityMatrixValuesUpdate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_locality_matrix_values.DeliveryLocalityMatrixValuesService/DeliveryLocalityMatrixValuesUpdate',
    ...
    @staticmethod
    def DeliveryLocalityMatrixValuesDelete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_locality_matrix_values.DeliveryLocalityMatrixValuesService/DeliveryLocalityMatrixValuesDelete',
