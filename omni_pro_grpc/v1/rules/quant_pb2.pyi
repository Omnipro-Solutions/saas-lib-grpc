...
class Quant(_message.Message):
    __slots__ = ["id", "product_doc_id", "location_sql_id", "quant_sql_id", "available_quantity", "active", "external_id", "object_audit"]
    ...
    def __init__(self, id: _Optional[str] = ..., product_doc_id: _Optional[str] = ..., location_sql_id: _Optional[int] = ..., quant_sql_id: _Optional[int] = ..., available_quantity: _Optional[float] = ..., active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...
...
class QuantCreateRequest(_message.Message):
    ...
    def __init__(self, product_doc_id: _Optional[str] = ..., location_sql_id: _Optional[int] = ..., quant_sql_id: _Optional[int] = ..., available_quantity: _Optional[float] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class QuantCreateResponse(_message.Message):
    ...
    def __init__(self, quant: _Optional[_Union[Quant, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class QuantReadResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, quants: _Optional[_Iterable[_Union[Quant, _Mapping]]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
...
class QuantDeleteRequest(_message.Message):
    ...
    quant_sql_id: int
    context: _base_pb2.Context
    def __init__(self, quant_sql_id: _Optional[int] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
