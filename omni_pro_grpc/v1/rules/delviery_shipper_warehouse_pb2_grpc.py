...
from omni_pro_grpc.v1.rules import delviery_shipper_warehouse_pb2 as v1_dot_rules_dot_delviery__shipper__warehouse__pb2
...
class DeliveryShipperWarehouseService(object):
    ...
    @staticmethod
    def DeliveryShipperWarehouseCreate(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_shipper_warehouse.DeliveryShipperWarehouseService/DeliveryShipperWarehouseCreate',
    ...
    @staticmethod
    def DeliveryShipperWarehouseRead(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_shipper_warehouse.DeliveryShipperWarehouseService/DeliveryShipperWarehouseRead',
    ...
    @staticmethod
    def DeliveryShipperWarehouseUpdate(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_shipper_warehouse.DeliveryShipperWarehouseService/DeliveryShipperWarehouseUpdate',
    ...
    @staticmethod
    def DeliveryShipperWarehouseDelete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.delivery_shipper_warehouse.DeliveryShipperWarehouseService/DeliveryShipperWarehouseDelete',
