...
class Warehouse(_message.Message):
    __slots__ = ["id", "name", "code", "warehouse_sql_id", "locality_available", "loc_stock_sql_id", "external_id", "schedule_template", "object_audit"]
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., code: _Optional[str] = ..., warehouse_sql_id: _Optional[int] = ..., locality_available: _Optional[_Union[_delivery_locality_pb2.DeliveryLocality, _Mapping]] = ..., loc_stock_sql_id: _Optional[int] = ..., external_id: _Optional[str] = ..., schedule_template: _Optional[_Union[_delivery_schedule_pb2.DeliverySchedule, _Mapping]] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...

class WarehouseCreateRequest(_message.Message):
    __slots__ = ["name", "code", "warehouse_sql_id", "locality_available_id", "loc_stock_sql_id", "external_id", "schedule_template_id", "context"]
    NAME_FIELD_NUMBER: _ClassVar[int]
    CODE_FIELD_NUMBER: _ClassVar[int]
    WAREHOUSE_SQL_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str] = ..., code: _Optional[str] = ..., warehouse_sql_id: _Optional[int] = ..., locality_available_id: _Optional[str] = ..., loc_stock_sql_id: _Optional[int] = ..., external_id: _Optional[str] = ..., schedule_template_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class WarehouseDeleteRequest(_message.Message):
    ...
    warehouse_sql_id: int
    context: _base_pb2.Context
    def __init__(self, id: _Optional[str] = ..., warehouse_sql_id: _Optional[int] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
