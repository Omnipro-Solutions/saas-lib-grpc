...
class ComputeService(object):
    ...
    def ComputeCreate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.compute.ComputeService/ComputeCreate',
    ...
    def ComputeRead(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.compute.ComputeService/ComputeRead',
    ...
    def ComputeUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.compute.ComputeService/ComputeUpdate',
    ...
    def ComputeDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pro.omni.oms.api.v1.rules.compute.ComputeService/ComputeDelete',
