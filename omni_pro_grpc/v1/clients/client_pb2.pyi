...
class Client(_message.Message):
    __slots__ = ["id", "name", "document_type", "document", "mobile", "phone", "email", "country", "addresses", "active", "external_id", "object_audit"]
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., document_type: _Optional[_Union[_type_document_pb2.TypeDocument, _Mapping]] = ..., document: _Optional[str] = ..., mobile: _Optional[str] = ..., phone: _Optional[str] = ..., email: _Optional[str] = ..., country: _Optional[_Union[_base_pb2.Object, _Mapping]] = ..., addresses: _Optional[_Iterable[_Union[_address_pb2.Address, _Mapping]]] = ..., active: bool = ..., external_id: _Optional[str] = ..., object_audit: _Optional[_Union[_base_pb2.ObjectAudit, _Mapping]] = ...) -> None: ...

class ClientCreateRequest(_message.Message):
    __slots__ = ["name", "document_type_id", "document", "mobile", "phone", "email", "country", "external_id", "context"]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str] = ..., document_type_id: _Optional[str] = ..., document: _Optional[str] = ..., mobile: _Optional[str] = ..., phone: _Optional[str] = ..., email: _Optional[str] = ..., country: _Optional[_Union[_base_pb2.Object, _Mapping]] = ..., external_id: _Optional[str] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class ClientCreateResponse(_message.Message):
    ...
    client: Client
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., client: _Optional[_Union[Client, _Mapping]] = ...) -> None: ...
...
class ClientReadResponse(_message.Message):
    ...
    def __init__(self, response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ..., meta_data: _Optional[_Union[_base_pb2.MetaData, _Mapping]] = ..., clients: _Optional[_Iterable[_Union[Client, _Mapping]]] = ...) -> None: ...
...
class ClientUpdateRequest(_message.Message):
    ...
    client: Client
    context: _base_pb2.Context
    def __init__(self, client: _Optional[_Union[Client, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class ClientSyncByHashRequest(_message.Message):
    ...
    context: _base_pb2.Context
    def __init__(self, info: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., shipping_address: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., billing_address: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., context: _Optional[_Union[_base_pb2.Context, _Mapping]] = ...) -> None: ...
...
class ClientSyncByHashResponse(_message.Message):
    ...
    response_standard: _base_pb2.ResponseStandard
    def __init__(self, data_client: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., response_standard: _Optional[_Union[_base_pb2.ResponseStandard, _Mapping]] = ...) -> None: ...
